...
<template>
    <div class="row h-100">
        <div class="col-2 bg-light right-shadow">
            <div class="container mt-3">
                ...
                <ul class="list-group list-group-flush">
                    <li class="list-group-item bg-light">
                        <router-link class="d-flex align-items-center gap-2" :to="{ name: 'salesInvoice' }">
                            <span><i class="fa-solid fa-file-lines"></i></span>
                            <span>{{ $t('menu.salesInvoice') }}</span>
                        </router-link>
                    </li>
                    <li class="list-group-item bg-light ">
                        <router-link class="d-flex align-items-center gap-2" :to="{ name: 'purchaseInvoice' }">
                            <span><i class="fa-solid fa-file-lines"></i></span>
                            <span>{{ $t('menu.purchaseInvoice') }}</span>
                        </router-link>
                    </li>
        ...
        <div class="col-10"><router-view></router-view></div>
    </div>
</template>
